...
export type Project_Filter = {
  ...
  additionalPayeeSecondarySalesPercentage_not_in?: Maybe<Array<Scalars['BigInt']>>;
  ...
  proposedArtistAddressesAndSplits_not_contains_nocase?: Maybe<Scalars['String']>;
  proposedArtistAddressesAndSplits_not_ends_with?: Maybe<Scalars['String']>;
  proposedArtistAddressesAndSplits_not_ends_with_nocase?: Maybe<Scalars['String']>;
  ...
  proposedArtistAddressesAndSplits_not_starts_with_nocase?: Maybe<Scalars['String']>;
...
export type Project_External_Asset_Dependency_Types_Aggregate_FieldsCountArgs = {
  columns?: Maybe<Array<Project_External_Asset_Dependency_Types_Select_Column>>;
  distinct?: Maybe<Scalars['Boolean']>;
};
...
export type Query_RootProject_External_Asset_Dependency_TypesArgs = {
  distinct_on?: Maybe<Array<Project_External_Asset_Dependency_Types_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
...
export type Subscription_RootProject_External_Asset_Dependency_Types_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<Maybe<Project_External_Asset_Dependency_Types_Stream_Cursor_Input>>;
  where?: Maybe<Project_External_Asset_Dependency_Types_Bool_Exp>;
};
...
export type GetTokensImagesQuery = (
  { __typename?: 'query_root' }
  & { tokens_metadata: Array<(
    { __typename?: 'tokens_metadata' }
    & Pick<Tokens_Metadata, 'id' | 'image_id'>
  )> }
);
